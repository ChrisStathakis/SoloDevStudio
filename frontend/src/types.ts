...
export interface StageWorkspace {
  ...
  shapingChecklist: ChecklistItem[];
  guidance: string;
  prompts: string[];
  shapingGuidance: string;
  shapingPrompts: string[];
  builtIn?: { checklist: ChecklistItem[]; shapingChecklist: ChecklistItem[] };
  createdAt?: string;
  updatedAt?: string;
}

export interface ChecklistItem { id: string; label: string; }
export interface StageChecklistDefault {
  stage: ProjectStage;
  checklist: ChecklistItem[];
  shapingChecklist: ChecklistItem[];
  isCustom?: boolean;
...
export interface DailyFocus { id?: string; day: string; taskIds: string[]; updatedAt?: string; }
